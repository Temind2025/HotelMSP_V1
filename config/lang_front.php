...
return [
    ...
    /* ----- txt ----- */
        ...
        'txt_dropdown_housekeeping_status'=>[
            'en'=>'Housekeeping Status Dropdowns',
            'hi'=>'हाउसकीपिंग स्थिति ड्रॉपडाउन',
        ],
        ...
        'txt_contact_person_email'=>[
            ...
            'hi'=>'संपर्क व्यक्ति का ईमेल',
        ],
        'txt_contact_person_mobile'=>[
            'en'=>'Contact Person Mobile',
            'hi'=>'संपर्क व्यक्ति का मोबाइल',
        ],
        'heading_vendor_info'=>[
            'en'=>'Vendor Information',
            'hi'=>'विक्रेता की जानकारी',
        ],
        'heading_housekeeping_orders'=>[
            'en'=>'Housekeeping Orders',
            'hi'=>'हाउसकीपिंग ऑर्डर',
        ],
        'heading_housekeeping_info'=>[
            'en'=>'Housekeeping Order Information',
            'hi'=>'हाउसकीपिंग ऑर्डर की जानकारी',
        ],
        'sidemenu_housekeeping'=>[
            'en'=>'Housekeeping',
            'hi'=>'हाउसकीपिंग',
        ],
        'sidemenu_housekeeping_item_add'=>[
            'en'=>'Add Item',
            'hi'=>'सामान जोडें',
        ],
        'sidemenu_housekeeping_item_all'=>[
            'en'=>'All Items',
            'hi'=>'सभी आइटम',
        ],
        'sidemenu_housekeeping_order_add'=>[
            'en'=>'Add Order',
            'hi'=>'आदेश जोड़ें',
        ],
        'sidemenu_housekeeping_order_all'=>[
            'en'=>'All Orders',
            'hi'=>'सभी ऑर्डर',
        ],
    /* ----- /txt ----- */
